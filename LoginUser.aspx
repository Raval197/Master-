<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginUser.aspx.cs" Inherits="reg_LoginUser" %>
...
<head runat="server">
	<title>User Login - Royal Hospital PVT</title>
...
<body>
	...
	<div>
		...
		<article class="card-body mx-auto" style="max-width: 400px;">
			...
			<p class="text-center">Not Have an account? <a href="RegisterUser.aspx">Sing In</a> </p>                                                                 
