<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppointmentManual.aspx.cs" Inherits="Appointment" %>
...
<body>
    ...
    <br />
        <table class="nav-justified">
            ...
            <span style="float:left;"><asp:Image ID="Image6" runat="server" ImageUrl="~/image/icon/Medical Doctor balck.png" Width="21px" /></span><p>Select Doctor : </p>
            <asp:DropDownList ID="ddlDoctor" runat="server" CssClass="form-control">
                <asp:ListItem >-- Select Doctor --</asp:ListItem>
            </asp:DropDownList>
                <br />
                
                <asp:Label ID="Label2" runat="server" Text="Booking Date:"></asp:Label> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdate" ErrorMessage="* Booking Date is Empty" ForeColor="Red"></asp:RequiredFieldValidator>
    <br />
