<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="reg_AdminLogin" %>
...
<html>
<head runat="server">
    <title>Admin Login - Royal Hospital PVT</title>
...
<body>
    ...
    <div>
        ...
        <article class="card-body mx-auto" style="max-width: 400px;">
	        <h4 class="card-title mt-3 text-center">Admin Login Account</h4>
            ...
            <span style="float:left;"><asp:Image ID="Image2" runat="server" ImageUrl="~/image/icon/Email Black.png" Width="21px" /></span><p>Admin ID:  
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserID" ErrorMessage="* Admin ID is Empty" ForeColor="Red"></asp:RequiredFieldValidator>
            </p>
            <asp:TextBox ID="txtUserID" runat="server"  CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>

                <br />

            <span style="float:left;"><asp:Image ID="Image5" runat="server" ImageUrl="~/image/icon/Lock  Black.png" Width="21px" /></span><p>Password: <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPassword" ErrorMessage="* Password is Empty" ForeColor="Red"></asp:RequiredFieldValidator>
            </p>
